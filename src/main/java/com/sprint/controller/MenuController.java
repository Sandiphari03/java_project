...
//	}
	...
	public Optional<Menu> allOrder(@PathVariable("id") int m_id){
		return mRepo.findById( m_id);
	}
	
	@DeleteMapping("/delete/{m_id}")
	public Map<String, Boolean> delete(@PathVariable(value="m_id")int m_id) throws ResourceNotFoundException{
	...
	public ResponseEntity<Menu> updateRestaurant(@PathVariable(value="id")int m_id,
